...
def preprocess_data(input_dir, dataset_key, dataset_labels, train_dataset_labels, gene_type, n_top_genes, gene_embedding_keys, marker_genes, gnn_type, mode, device):
    ...
    if mode == "train":
        ...
        # seurat flavor은 log-normalized 데이터를 기대함
...
def compute_gene_adjacency_matrix(input_dir, species, gene_type, analyzed_genes, GODag_path, num_workers_fetch=1, num_workers_compute=None):
